...
public class MainActivity extends AppCompatActivity {
    ...
    private void mostraMensagem(String mensagem){
        boolean pronto = mensagem.contains("falha");
        if(pronto == false){
            Toast.makeText(MainActivity.this, "opa! Sucesso!", Toast.LENGTH_SHORT).show();
        }else {
            Toast.makeText(MainActivity.this, "Hum! Erro!", Toast.LENGTH_SHORT).show();
        }
    }
